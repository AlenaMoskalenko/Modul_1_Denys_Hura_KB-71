...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Manager manager4 = new Manager(4844,"Vlad","Lisuy", 2500000, manager3,4000);
        Manager manager5 = new Manager(52484, "Vadim", "Bylochka", 20000, manager4, 3000);
        Manager manager6 = new Manager(555959, "Volodya","Pirigok", 19000, manager5,2000);
